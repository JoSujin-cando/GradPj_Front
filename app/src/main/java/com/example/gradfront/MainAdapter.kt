...
class MainAdapter(private val dataList: List<LivePerformanceResponse>, private val MainClick: (LivePerformanceResponse) -> Unit) :
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        ...
        holder.binding.perfTitle.text = item.title
        holder.binding.bandLineUp.text = item.bandLineup
        holder.binding.perfImg.load(item.image)
